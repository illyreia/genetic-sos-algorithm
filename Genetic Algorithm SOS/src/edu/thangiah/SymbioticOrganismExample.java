...
public class SymbioticOrganismExample {
  /**
   * Starts the example.
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      gaConf.addGeneticOperator(new MutualismPhaseOperator(gaConf));
      gaConf.addGeneticOperator(new CommensalismPhaseOperator(gaConf));
      gaConf.addGeneticOperator(new ParasitismPhaseOperator(gaConf));
    ...
    System.out.println(genotype.getFittestChromosome() + " = Most fit chromosome with fitness: " + fittest.getFitnessValue());
  }
}
